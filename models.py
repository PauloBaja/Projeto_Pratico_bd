...
class Departamento(Base):
    ...
    professor: Mapped[Optional['Professor']] = relationship('Professor', foreign_keys=[chefe], back_populates='departamento_chefe')
...
class Professor(Base):
    ...
    departamento_chefe: Mapped[list['Departamento']] = relationship('Departamento', foreign_keys='[Departamento.chefe]', back_populates='professor')
